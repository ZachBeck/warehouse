...
class UempPallet(Pallet):
    def ship(self):
        try:
            ...
            sdeconnection = join(self.garage, UEMP, 'sde@UEMP@itdb104sp.dts.utah.gov.sde')
            ...
            userconnections = [join(self.garage, UEMP, 'uempadmin@UEMP@uemp.agrc.utah.gov.sde')]
