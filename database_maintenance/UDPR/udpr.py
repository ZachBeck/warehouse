...
sdeconnection = r'C:\Scheduled\UDPR\DNR_sde@UDPR@itdb104sp.dts.utah.gov.sde'
...
userconnections = [r'C:\Scheduled\UDPR\DNR_OHV@UDPR@itdb104sp.dts.utah.gov.sde',\
                    r'C:\Scheduled\UDPR\DNR_susanz@UDPR@itdb104sp.dts.utah.gov.sde']
